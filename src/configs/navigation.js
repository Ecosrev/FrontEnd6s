...
export function AuthenticatedTabScreens() {
  return (
    <Tab.Navigator tabBar={(props) => <BottomNavigation {...props} />} screenOptions={{ headerShown: false }}>
      ...
      <Tab.Screen name="QRCodeScannerTab" component={QRCodeScannerScreen} options={{ title: "Scanner" }} />
      <Tab.Screen name="ResetPasswordTab" component={ResetPasswordScreen} options={{ title: "Reset Password" }} />
      <Tab.Screen name="ConfigTab" component={ConfigScreen} options={{ title: "Configurações" }} />
      <Tab.Screen name="ForgotPasswordTab" component={ForgotPasswordForm} options={{ title: "Forgot Password" }} />
      <Tab.Screen name="AboutTab" component={AboutScreen} options={{ title: "About" }} />
      <Tab.Screen name="LogoutTab" component={LogoutButton} options={{ title: "Logout" }} />
    </Tab.Navigator>
  );
}
...
export function AppStack() {
  // Always show authenticated screens for testing
